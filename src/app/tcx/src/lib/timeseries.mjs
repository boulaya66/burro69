...
/**
 * @file tcx app: lib/timeseries.mjs
 * 
 * Time series post processing
 * @memberof module:tcx
 * @namespace tcx/timeseries
*/

/**
 * Base class for time series processing
 * @alias timeSeries
 * @memberof tcx/timeseries
 * @class
 * @abstract
 */
class _series {
    /**
     * Time series base class constructor
     */
    constructor() {
        this._result = 0.0;
    }
    /**
     * Return the result of the class processing with the specified precision
     * @param {number} [precision] The required precision, or 2 by default
     * @returns {number} The result of the timeseries class processing
     */
    result(precision) {
    ...
    /**
     * Abstract method. Should be overridden with the required 'next time event' 
     * processing.
     * @abstract
     */
    next() { }
    /**
     * Should be overridden with the required 'end of series event' 
     * processing. Returns the result with the specified precision.
     * @abstract
     * @param {number} [precision] The required precision, or 2 by default
     * @returns {number} The result of the timeseries class processing
     */
    ...
    /**
     * Returns the result of the class processing in a string with a 
     * precision of 0 (integer value).
     * @returns {string} The stringified result with no decimal part.
     */
    toString() {
...
/**
 * Trim decimal part of a number, with the specified number of decimals.
 * @alias toDigits
 * @memberof tcx/timeseries
 * @inner
 * @function
 * @param {number} value The value to transform
 * @param {number} [digits=2] The number of decimals.
 * @returns {number}
 */
