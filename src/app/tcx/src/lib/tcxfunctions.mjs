...
//#region Import internal dependencies
 ...
 * file tcx app: lib/tcxfunctions.mjs
 */
...
/**
 * Combine two or more source tcx files in one destination file.
 * 
 * Laps of source files will be concatenated (in left to right order).
 * @alias combineTCX
 * @memberof module:tcx
 * @memberof tcx/lib
 * @function
 * @param {String[]} src The source files to combine.
...
async function getMetrics(src, ftp, smoothing) {
    ...
    return {
        ...
        activity: {
            ...
            AvgEstimatedPower: mEPower.result(0),
