...
/**
 * Read, parse a TCX file and returns an object.
 * @alias readTCX
 * @memberof module:tcx
 * @memberof tcx/lib
 * @inner
 * @function
 * @param {string} src The TCX file path to parse.
...
/**
 * Given an object representing an activity following the structure of a TCX file, 
 * build the tcx/xml structure and save the result in the destination file.
 * @alias writeTCX
 * @memberof module:tcx
 * @memberof tcx/lib
 * @inner
 * @function
 * @param {string} obj The TCX object to save. 
